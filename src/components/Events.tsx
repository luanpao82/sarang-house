...
const events = [
  {
    ...
    descEn: "Tour our classrooms, meet instructors, and register for spring ESL classes. All levels welcome.",
    descKr: "교실을 둘러보고, 강사를 만나고, 봄 ESL 수업에 등록하세요. 모든 레벨 환영합니다.",
    tag: "Education",
    tagKr: "교육",
  },
  {
    ...
    descEn: "Free legal workshop covering immigrant rights, visa updates, and Q&A with immigration attorneys.",
    descKr: "이민자 권리, 비자 업데이트, 이민 변호사와의 Q&A를 다루는 무료 법률 워크숍입니다.",
    tag: "Workshop",
    tagKr: "워크숍",
  },
  {
    ...
    titleKr: "한국 문화 축제",
    descEn: "Celebrate Korean heritage with food, music, traditional performances, and family-friendly activities.",
    descKr: "음식, 음악, 전통 공연, 가족 활동과 함께 한국 문화유산을 축하합니다.",
    tag: "Community",
    tagKr: "커뮤니티",
  },
  {
    ...
    titleKr: "이민자 취업 박람회",
    descEn: "Connect with local employers. Bring your resume! Interpretation available in Korean, Mandarin, and Vietnamese.",
    descKr: "지역 고용주와 만나보세요. 이력서를 가져오세요! 한국어, 중국어, 베트남어 통역이 제공됩니다.",
    tag: "Career",
    tagKr: "취업",
  },
];
